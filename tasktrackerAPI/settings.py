...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173" , 
    "https://tasktrackerfrontend-b0125962c8ee.herokuapp.com"
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": (
        "rest_framework.permissions.IsAuthenticated",  # default protect; open specific views as needed
    ),
}
...
# WhiteNoise settings (recommended for Django 5)
STORAGES = {
    "staticfiles": {
